const i18n = {
  ko: {
    ...
    needs1Body: "더 나은 실적을 만들 수 있는 최적화 엔진. 규제 반영 다중 제약 최적화, 기존 시스템과의 API 통합, 감사 추적이 가능한 운용 프로세스",
    ...
    customer1Body: "다양한 제약 조건 하에서 대규모 포트폴리오를 운용하며, 규제 준수와 리스크 관리가 중요한 기관. API/플러그인 형태로 기존 시스템에 통합 가능",
    customer2Title: "헤지펀드 및 패밀리오피스",
    customer2Body: "규제에서 비교적 자유로우며, 최고 수준의 투자 성과와 새로운 기술 도입을 추구하는 기관",
    customer3Title: "데이터 및 기술 파트너",
    customer3Body: "금융 데이터 벤더, AI 기업, 양자 컴퓨팅 하드웨어 기업 등과의 밸류체인 협업을 통해 상호 부가가치 창출",
  ...
  en: {
    ...
    needs1Body: "An optimization engine that drives better performance. Regulation-aware multi-constraint optimization, API integration with existing systems, auditable portfolio management processes",
    ...
    customer1Body: "Institutions managing large portfolios under various constraints, where regulatory compliance and risk management are critical. Integrates via API/plugin into existing systems",
    ...
    customer3Title: "Data & Technology Partners",
    customer3Body: "Value chain collaboration with financial data vendors, AI companies, and quantum computing hardware firms for mutual value creation",
