const i18n = {
  ko: {
    ...
    heroTitle: "생성형 AI 시대, 금융 포트폴리오 최적화를 구현하는 <br class='br-md' /><span class='accent'>새로운 방식</span>",
  ...
  en: {
    ...
    heroTitle: "A <span class='accent'>new approach</span> <br class='br-md' />to portfolio optimization in the generative AI era",
